...
## 7. Frontend + flow ผู้ใช้

โค้ด FE อยู่ที่ [`../frontend/`](../frontend/) — **เล่า flow แบบละเอียดทีละบทบาท** (login → import → normalize → ใบงาน → หลักฐาน → แดชบอร์ด / KPI / jobs) ดู [`SYSTEM_FLOWS.md`](SYSTEM_FLOWS.md) · โครงโฟลเดอร์และ route ดู [`FRONTEND_STRUCTURE.md`](FRONTEND_STRUCTURE.md) §3–5
...
| 1.2 | 2026-05-05 | §7 อ้าง `SYSTEM_FLOWS.md` + โค้ด `frontend/` ใน repo |
